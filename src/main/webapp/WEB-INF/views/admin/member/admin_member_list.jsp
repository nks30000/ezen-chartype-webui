...
<link rel="stylesheet" href="/charType/resources/css/cutword.css">
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <ul class="nav nav-tabs" id="myTab">
                <li class="active"><a href="#home" data-toggle="tab">Userdata</a></li>
            ...
            <div class="tab-content">
				...
				<c:forEach items="${map.allUserList }" var="row">
                            <thead>
                                <tr>
                                    <th>NO</th>
                                    <th>ID</th>
                            ...
                            <tbody id="items">
                                <tr>
                                    ...
                                    <td>${row.REG_DT} </td>
                                    <td>${row.MBTI}</td>
                                    <td><span class="singleline-ellipsis" style="display:inline-block;width: 300px;">${row.INTRO}</span> </td>
                                </tr>
                            </tbody>
                            </c:forEach>
                        </table>
