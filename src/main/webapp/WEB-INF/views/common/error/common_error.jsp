	        ...
	        <div class="row">
	            <div class="col-md-12 ">
	                <div class="error-text">
	                    ...
	                    <h4>Oops! This page Could Not Be Found or Something Wrong!</h4>
	                    <p>Sorry bit the page you are looking for does not exist, have been removed or name changed.</p>
	                    <a href="/charType/member/login/form" target='_blank' class="btn btn-primary btn-round">Go to Mainpage</a>
	                </div>
	            </div>
	        </div>
	    </div>
