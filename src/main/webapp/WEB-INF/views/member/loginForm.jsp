...
<html lang="en" class=""><head>
  ...
  <script language="JavaScript" src="/charType/resources/script/script.js"></script>
  </head>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 ml-auto mr-auto">
            <div class="card card-login">
              <form action="/charType/memberlogin.do" name="userinput" onSubmit="return checkIt()" method="post" >
                ...
                <%-- <spring:hasBindErrors name="mem"/> --%>
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" class="form-control" id="password" name="password" value="${mem.password }" placeholder="Password">
                    <%-- <form:errors cssClass="text-danger small" path="mem.password"/> --%>
                  </div>
                </div>
                <div class="footer text-center">
                  <button type="submit" class="btn btn-primary btn-link btn-wd btn-lg">Login</button> 
                  <a href="memberReg.do" class="btn btn-primary btn-link btn-wd btn-lg">Sign up</a>
