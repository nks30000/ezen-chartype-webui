...
<head>
	...
	<script language="JavaScript" src="/charType/resources/script/script.js" charset="UTF-8"></script>
</head>
              ...
              <%-- <spring:hasBindErrors name="mem"/> --%>
                ...
                <div class="pl-lg-4">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <div class="input-group">
	                        <input type="text"  id="reg_id" name="id" value="${mem.id }" class="form-control form-control-alternative" placeholder="ID">
                        </div>
                  ...
                  <div class="row">
                      ...
                      <div class="form-group focused">
                        ...
                        <input type="password" id="reg_password" name="password" value="${mem.password }" placeholder="Password" class="form-control form-control-alternative" placeholder="Password">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Rewrite Password</label>
                        <input type="password"  id="reg_confirmPassword" name="confirmPassword" value="${mem.confirmPassword }" placeholder="Rewrite Password" class="form-control form-control-alternative" >
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="pl-lg-4">
                	<div class="form-group">
                		...
                		<div>
                			<div>
		                		<%-- <input type="checkbox" name="private_yn"value="${mem.private_yn }" /> <span>�⑤��占쏙옙�占�</span> --%>
                	...
                	<div class="row">
	                    	...
	                    	<div class="form-group ">
			                    ...
			                    <div class="text-center my-4">
			  					...
			  					<div class="text-right">
			  						<input type="file" name="file" name="prof_img" value="${mem.prof_img }">
			  					</div>
			  					<br><br>
	                    ...
	                    <div class="col-8">
	                      ...
	                      <div class="form-group">
	                        <label class="form-control-label" for="input-MBTI" value="${mem.mbti }">MBTI
	                        </label>
					...
					<div class="row">
	                    <div class="col-lg-6">
	                      <div class="form-group focused">
	                        ...
	                        <div class="input-group">
		                        <input type="file"  id="" name="back_img" value="${mem.back_img }" class="form-control form-control-alternative" placeholder="">
	                        </div>
	                      </div>
	                    </div>
